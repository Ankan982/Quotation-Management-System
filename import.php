		...
		echo $filename=$_FILES["file"]["tmp_name"];
		 ...
		 if($_FILES["file"]["size"] > 0)
		 {
	         ...
	         while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
	         {
			  ...
			  $sql = "INSERT into `BatchImport_tmp` (`part_number`, `qty`,`Qnum`,`LineSeq`) 
	         ...
	         fclose($file);
	         //throws a message if data successfully imported to mysql database from excel file window.location = \"import_page.php\"
	         echo "<script type=\"text/javascript\">
